...
class Window(Frame):
    def __init__(self, master=None):
        ...
        self.annotateButton = Button(self, text="Annotate XML",
                                     command=lambda: self.start_background_task(self.annotate, "Annotating"))
        self.annotateButton.pack(side=RIGHT, expand=False, padx=8, pady=4)

        self.extractButton = Button(self, text="Extract game assets",
                                    command=lambda: self.start_background_task(self.extract_assets, "Extracting"))
